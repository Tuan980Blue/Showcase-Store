                    ...
                    <div className="flex-shrink-0">
                      {product.imageUrl ? (
                        <img
                          ...
                          alt={product.name}
                          className="h-20 w-20 object-cover rounded-lg border-2 border-gray-200 shadow-sm hover:shadow-md transition-shadow"
                        />
                      ) : (
                        <div className="h-20 w-20 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg border-2 border-gray-200 flex items-center justify-center">
                          <svg
